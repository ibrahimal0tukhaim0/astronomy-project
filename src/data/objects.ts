...
export const celestialObjects: CelestialData[] = [
    ...
    // محطة الفضاء الدولية (ISS) - بمدار خارجي ضخم
    {
        ...
        science: {
            ...
            orbitRadius: 30000, // 🛰️ 50% Increase (was 20000)
            orbitSpeed: 0.1, // Slow down slightly for larger orbit
            orbitInclination: 20.0, // Tilted orbit
            orbitPhase: 0,
            glowIntensity: 2.0,
            facts: 'النوع: قمر صناعي مأهول (مختبر أبحاث)\nالارتفاع عن الأرض: ٤٠٠ كيلومتر (المتوسط)\nالحجم (الأبعاد): ١٠٩ أمتار (بحجم ملعب كرة قدم)\nالسرعة: ٢٧,٦٠٠ كم/ساعة\nأضخم بناء شيده الإنسان في الفضاء، تدور حول الأرض ١٦ مرة يومياً، وتعتبر منارة للعلم والتعاون البشري.',
            quranse: '{ عَلَّمَ الْإِنسَانَ مَا لَمْ يَعْلَمْ }\nسورة العلق | آية ٥\n\nمن كرم الله ورحمته أنه أخرج الإنسان من ظلمة الجهل إلى نور المعرفة، ووهبه العقل الذي مكنه من ابتكار هذه المحطة المعقدة واكتشاف أسرار الكون، فكانت تجلياً لتعليم الله للإنسان ما لم يكن يعلم.',
            history: 'تاريخ الإطلاق: ٢٠ نوفمبر ١٩٩٨\nالهدف: مختبر لعلوم انعدام الجاذبية "آية في التسخير."',
            note: 'تأمل "حفظُ حياة البشر في ظلمات الفضاء داخل هذه الغرفة المعدنية الصغيرة، وجريانها بدقة متناهية، شاهد حي على عظمة الخالق وحفظه."'
        },
        initialPosition: [30000, 1072, 0], // x=30000, y=715*1.5=1072
    },
